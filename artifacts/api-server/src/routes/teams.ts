...
router.post("/teams", adminAuthMiddleware, async (req, res) => {
...
router.patch("/teams/:id", adminAuthMiddleware, async (req, res) => {
...
router.delete("/teams/:id", adminAuthMiddleware, async (req, res) => {
